...
public abstract class ErrorMsg {
  ...
  public abstract static class Builder {
    public @Nullable abstract Builder setTransform(String value);

    public @Nullable abstract Builder setError(String value);

    public @Nullable abstract Builder setData(String value);

    public @Nullable abstract Builder setTimestamp(Instant value);
