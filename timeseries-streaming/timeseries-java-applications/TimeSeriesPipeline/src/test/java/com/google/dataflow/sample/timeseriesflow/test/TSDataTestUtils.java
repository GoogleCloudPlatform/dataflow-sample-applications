...
public class TSDataTestUtils {
  ...
  public static final TimeSeriesData.TSKey KEY_A_C =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-A").setMinorKeyString("MKey-c").build();
  public static final TimeSeriesData.TSKey KEY_B_A =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-B").setMinorKeyString("MKey-a").build();
  public static final TimeSeriesData.TSKey KEY_B_B =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-B").setMinorKeyString("MKey-b").build();
  public static final TimeSeriesData.TSKey KEY_B_C =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-B").setMinorKeyString("MKey-c").build();
  public static final TimeSeriesData.TSKey KEY_C_A =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-C").setMinorKeyString("MKey-a").build();
  public static final TimeSeriesData.TSKey KEY_C_B =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-C").setMinorKeyString("MKey-b").build();
  public static final TimeSeriesData.TSKey KEY_C_C =
      TimeSeriesData.TSKey.newBuilder().setMajorKey("Key-C").setMinorKeyString("MKey-c").build();
