 ...
 */
@Experimental
public abstract class ConvertAccumToSequenceV2
    extends PTransform<PCollection<KV<TSKey, TSAccum>>, PCollection<KV<TSKey, TSAccumSequence>>> {

  private static final Logger LOG = LoggerFactory.getLogger(ConvertAccumToSequenceV2.class);
  ...
  public static Builder builder() {
    return new AutoValue_ConvertAccumToSequenceV2.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract ConvertAccumToSequenceV2 build();
  }
  ...
  public static class AccumToSequencesDoFn
    ...
    ConvertAccumToSequenceV2 convertAccumToSequence;

    public AccumToSequencesDoFn(ConvertAccumToSequenceV2 convertAccumToSequence) {
