...
public class Test2Fn extends BTypeTwoFn {
  ...
  public SerializableFunction<KV<TSKey, TSAccumSequence>, KV<TSKey, TSAccum>> getFunction(
    ...
    return (SerializableFunction<KV<TSKey, TSAccumSequence>, KV<TSKey, TSAccum>>)
        element -> {
          return KV.of(element.getKey(), TSAccum.newBuilder().build());
        };
  }

  /** Options for {@link Test2Fn} fn. */
  public static interface TestFnOptions extends PipelineOptions {}
}
