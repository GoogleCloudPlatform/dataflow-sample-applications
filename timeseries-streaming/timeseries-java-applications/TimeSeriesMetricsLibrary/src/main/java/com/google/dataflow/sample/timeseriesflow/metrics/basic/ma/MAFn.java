...
public class MAFn extends BType2Fn {
  ...
  public SerializableFunction<KV<TSKey, TSAccumSequence>, KV<TSKey, TSAccum>> getFunction(
    ...
    if (maOptions.getAverageComputationMethod()
        == AverageComputationMethod.EXPONENTIAL_MOVING_AVERAGE) {

      final Double alpha = Optional.ofNullable(maOptions.getAverageComputationAlpha()).orElse(0D);
